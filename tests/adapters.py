...
def run_swiglu(
    ...
    with torch.no_grad():
        module.w1.copy_(w1_weight.T)
        module.w2.copy_(w2_weight.T)
        module.w3.copy_(w3_weight.T)
...
def run_rmsnorm(
    ...
    """
    from cs336_basics.modules.rmsnorm import RMS_Norm
    module=RMS_Norm(d_model,eps)
    with torch.no_grad():
        module.weight.copy_(weights)
    return module.forward(in_features)
